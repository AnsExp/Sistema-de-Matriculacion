...
{
    internal class GridEstudiante : TableLayoutPanel
    {
        ...
        private readonly DataGridViewTextBoxColumn
            ...
            notaGradoColumn = new DataGridViewTextBoxColumn { HeaderText = "Nota de grado", Name = "notaGrado" },
        ...
        internal GridEstudiante()
        {
            ...
            ControlGrid.LlenarGrid(grid, TypeData.Estudiante);

            grid.AllowUserToAddRows = false;
            btnAplicarFiltro.Click += EjecutarFiltro;
            cmbFiltro.SelectedIndexChanged += CambiarFiltro;
            btnLlenarTabla.Click += (object sender, EventArgs e) => ControlGrid.LlenarGrid(grid, TypeData.Estudiante);
        }
